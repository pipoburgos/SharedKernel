...
{
    [Fact]
    public void SameHouseCityWithSameUsers_NotWorkingOnRecords()
    {
        //Arrange
    ...
    [Fact]
    public void SameCityWithSameAddress_NotWorkingOnRecords()
    {
        //Arrange
        var address1 = new Address("streetLine1", "streetLine2", "city", "zipcode");
        var address2 = new Address("streetLine1", "streetLine2", "city", "zipcode");
    ...
    [Fact]
    public void SameListAreEquals_NotWorkingOnRecords()
    {
        //Arrange
        ...
        //Assert
        Assert.False(integers1.Equals(integers2));
        Assert.NotEqual(integers1, integers2);
    }


    [Fact]
    public void SameListDistinctOrderAreEquals_NotWorkingOnRecords()
    {
        //Arrange
