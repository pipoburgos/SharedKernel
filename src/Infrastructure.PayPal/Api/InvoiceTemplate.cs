...
public class InvoiceTemplate : PayPalResource
{
    ...
    public InvoiceTemplate Create(APIContext apiContext)
    {
        ...
        var resource = "v1/invoicing/templates";
        return ConfigureAndExecute<InvoiceTemplate>(apiContext, HttpMethod.Post, resource, ConvertToJson());
    }
    ...
    public InvoiceTemplate Update(APIContext apiContext)
    {
        ...
        return ConfigureAndExecute<InvoiceTemplate>(apiContext, HttpMethod.Put, resource, ConvertToJson());
    }
}