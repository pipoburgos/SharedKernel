...
public class Payment : PayPalRelationalObject
{
    ...
    public Payment Create(APIContext apiContext) => Create(apiContext, this);
    ...
    public static Payment Create(APIContext apiContext, Payment payment)
    {
        ...
        var payment1 = ConfigureAndExecute(apiContext, HttpMethod.Post, resource, payment);
    ...
    public static Payment Get(APIContext apiContext, string paymentId)
    {
        ...
        return ConfigureAndExecute<Payment>(apiContext, HttpMethod.Get, resource);
    }
        ...
        PaymentExecution paymentExecution)
    {
        ...
        return ConfigureAndExecute<Payment>(apiContext, HttpMethod.Post, resource, paymentExecution);
    }
        ...
        string sortOrder = "")
    {
        ...
        return ConfigureAndExecute<PaymentHistory>(apiContext, HttpMethod.Get, resource);
    }
}