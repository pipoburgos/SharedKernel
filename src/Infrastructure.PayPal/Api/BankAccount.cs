...
public class BankAccount : PayPalRelationalObject
{
    ...
    public BankAccount Create(IPayPalClient apiContext)
    {
    ...
    /// <returns>BankAccount</returns>
    public static BankAccount Create(IPayPalClient apiContext, BankAccount bankAccount)
    {
    ...
    /// <returns>BankAccount</returns>
    public static BankAccount Get(IPayPalClient apiContext, string bankAccountId)
    {
        ArgumentValidator.ValidateAndSetupApiContext(apiContext);
    ...
    /// <param name="apiContext">IPayPalClient used for the API call.</param>
    /// <param name="bankAccountId">Identifier of the bank account resource to obtain the data for.</param>
    public static void Delete(IPayPalClient apiContext, string bankAccountId)
    {
        ArgumentValidator.ValidateAndSetupApiContext(apiContext);
        ArgumentValidator.Validate(bankAccountId, nameof(bankAccountId));
    ...
    /// <returns>BankAccount</returns>
    public BankAccount Update(IPayPalClient apiContext, PatchRequest patchRequest)
    {
        if (string.IsNullOrWhiteSpace(Id))
            throw new ArgumentException(nameof(Id));
