...
public class CreateFromAuthorizationCodeParameters : ClientCredentials
{
    ...
    /// <summary>
    /// Initializes a new <seealso cref="T:SharedKernel.Infrastructure.PayPal.Api.CreateFromAuthorizationCodeParameters" /> object and sets the grant type to 'authorization_code'.
    /// </summary>
    ...
    public void SetCode(string code) => ContainerMap[nameof (code)] = code;
    ...
    public void SetGrantType(string grantType) => ContainerMap["grant_type"] = grantType;
}