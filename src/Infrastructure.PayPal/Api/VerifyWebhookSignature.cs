...
public class VerifyWebhookSignature : PayPalRelationalObject
{
    ...
    public VerifyWebhookSignatureResponse Post(APIContext apiContext)
    {
        ...
        var resource = "v1/notifications/verify-webhook-signature";
        return ConfigureAndExecute<VerifyWebhookSignatureResponse>(apiContext, HttpMethod.Post, resource, ConvertToJson());
    }
}