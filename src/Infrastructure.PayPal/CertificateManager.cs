...
public sealed class CertificateManager
{
    ...
    private static Logger _logger = Logger.GetLogger(typeof(CertificateManager));
    ...
    public bool ValidatePayPalClientCertificate(X509Certificate2Collection clientCerts)
    {
        ...
        var array = Regex.Matches(clientCerts[0].Subject, "CN=[a-zA-Z._-]+").Cast<Match>().Select((Func<Match, string>)(m => m.Value)).ToArray();
