...
public static class SwaggerGenOptionsExtensions
{
    ...
    /// Don't set this flag if you're customizing the default tag for operations via TagActionsBy.
    /// </param>
    public static string? IncludeXmlComments(this SwaggerGenOptions swaggerGenOptions,
        IEnumerable<string> filePaths, bool includeControllerXmlComments = false)
    {
        ...
        XElement? xml = null;
        foreach (var qualifiedFileName in filesList.Select(fileName =>
