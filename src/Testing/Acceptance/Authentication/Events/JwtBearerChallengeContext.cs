...
{
    /// <summary> JwtBearerChallengeContext. </summary>
    ...
    /// <summary> Any failures encountered during the authentication process. </summary>
    public Exception AuthenticateFailure { get; set; } = null!;
