...
using SharedKernel.Testing.Acceptance.Authentication.Events;
...
namespace SharedKernel.Testing.Acceptance.Authentication
{
    ...
    public class FakeJwtBearerOptions : AuthenticationSchemeOptions
    {
        ...
        /// </summary>
        public string Challenge { get; private set; } = FakeJwtBearerDefaults.AuthenticationScheme;
        ...
        /// </summary>
        public HttpMessageHandler BackchannelHttpHandler { get; private set; } = null!;

        /// <summary>
        /// Gets or sets the timeout when using the backchannel to make an http call.
        /// </summary>
        public TimeSpan BackchannelTimeout { get; private set; } = TimeSpan.FromMinutes(1);

        /// <summary>
        /// Gets or sets if a metadata refresh should be attempted after a SecurityTokenSignatureKeyNotFoundException. This allows for automatic
        /// recovery in the event of a signature key rollover. This is enabled by default.
        /// </summary>
        public bool RefreshOnIssuerKeyNotFound { get; private set; } = true;
        ...
        /// </summary>
        public bool IncludeErrorDetails { get; private set; } = true;
    }
}
