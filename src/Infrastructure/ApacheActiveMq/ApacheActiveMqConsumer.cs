...
/// </summary>
public class ApacheActiveMqConsumer : BackgroundService
{
    ...
    public ApacheActiveMqConsumer(IServiceScopeFactory serviceScopeFactory)
    {
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        var logger = scope.ServiceProvider.GetRequiredService<ICustomLogger<ApacheActiveMqConsumer>>();
    ...
    private async Task<IMessageConsumer> ConsumeQueue(IOptions<ApacheActiveMqConfiguration> configuration, ISession session,
        IRequestMediator domainEventMediator, ICustomLogger<ApacheActiveMqConsumer> logger)
    {
    ...
    private async Task<IMessageConsumer> ConsumeTopics(ISession session, IRequestMediator domainEventMediator,
        ICustomLogger<ApacheActiveMqConsumer> logger)
    {
