...
{
    public abstract class RedisRepositoryAsync<TAggregateRoot, TKey> : RedisRepository<TAggregateRoot, TKey>, IRepositoryAsync<TAggregateRoot> where TAggregateRoot : class, IAggregateRoot, IEntity<TKey>
    {
