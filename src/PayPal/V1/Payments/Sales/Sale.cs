using PayPal.V1.Payments.Refunds;
...
After:
using SharedKernel.Infrastructure.PayPal.V1.Payments.Refund;
using SharedKernel.Infrastructure.PayPal.V1.Payments.Refund.Refund;
using SharedKernel.Infrastructure.PayPal.V1.Payments.Refund.Refund.Refund;
using SharedKernel.Infrastructure.PayPal.V1.Shared;
*/
...
using SharedKernel.Infrastructure.PayPal.V1.Shared;
After:
using SharedKernel.Infrastructure.PayPal.V1.Payments.Sale;
using SharedKernel.Infrastructure.PayPal.V1.Payments.Sale.Sale;
using SharedKernel.Infrastructure.PayPal.V1.Payments.Sale.Sale.Sale;
using SharedKernel.Infrastructure.PayPal.V1.Shared;
*/
...
namespace PayPal.V1.Payments.Sales;
