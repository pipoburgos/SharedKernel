...
using PayPal.V1.Vaults.CreditCards;
...
public class CreditCard : PayPalRelationalObject
{
    ...
    public static CreditCard Create(IPayPalClient apiContext, CreditCard creditCard)
    {
        ...
        return ConfigureAndExecute(apiContext, "POST", resource, creditCard);
    }
    ...
    public static CreditCard Get(IPayPalClient apiContext, string creditCardId)
    {
        ...
        return ConfigureAndExecute<CreditCard>(apiContext, "GET", resource);
    }
    ...
    public CreditCard Update(IPayPalClient apiContext, PatchRequest patchRequest)
    {
        ...
        return ConfigureAndExecute<CreditCard>(apiContext, "PATCH", resource, patchRequest);
    }
        ...
        bool totalRequired = true)
    {
        ...
        return ConfigureAndExecute<CreditCardList>(apiContext, "GET", resource);
    }
}