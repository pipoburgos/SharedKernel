...
namespace PayPal.V1.Payments.Authorizations;
...
public class Authorization : PayPalRelationalObject
{
    ...
    public static Authorization Get(IPayPalClient apiContext, string authorizationId)
    {
    ...
    /// <param name="apiContext">IPayPalClient used for the API call.</param>
    /// <returns>Authorization</returns>
    public Authorization Void(IPayPalClient apiContext)
    {
        if (string.IsNullOrWhiteSpace(Id))
            throw new ArgumentException(nameof(Id));
    ...
    /// <returns>Authorization</returns>
    public static Authorization Void(IPayPalClient apiContext, string authorizationId)
    {
        ArgumentValidator.ValidateAndSetupApiContext(apiContext);
        ArgumentValidator.Validate(authorizationId, nameof(authorizationId));
    ...
    /// <param name="apiContext">IPayPalClient used for the API call.</param>
    /// <returns>Authorization</returns>
    public Authorization Reauthorize(IPayPalClient apiContext)
    {
    ...
    /// <returns>Authorization</returns>
    public static Authorization Reauthorize(IPayPalClient apiContext, Authorization authorization)
    {
        if (string.IsNullOrWhiteSpace(authorization.Id))
            throw new ArgumentException(nameof(authorization.Id));
