...
After:
using SharedKernel.Infrastructure.PayPal.V1.Payments.Authorization;
using SharedKernel.Infrastructure.PayPal.V1.Payments.Authorization.Authorization;
using SharedKernel.Infrastructure.PayPal.V1.Payments.Authorization.Authorization.Authorization;
using SharedKernel.Infrastructure.PayPal.V1.Shared;
*/
...
namespace PayPal.V1.Payments.Orders;
