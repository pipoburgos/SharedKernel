...
namespace PayPal.V1.Payments.BillingAgreements;
...
public class Agreement : PayPalRelationalObject
{
    ...
    public Agreement Create(IPayPalClient apiContext)
    {
    ...
    /// <returns>Agreement</returns>
    public static Agreement Create(IPayPalClient apiContext, Agreement agreement)
    {
    ...
    /// <param name="apiContext">IPayPalClient used for the API call.</param>
    /// <returns>Agreement</returns>
    public Agreement Execute(IPayPalClient apiContext)
    {
        if (string.IsNullOrWhiteSpace(Token))
            throw new ArgumentException(nameof(Token));

        return Execute(apiContext, Token);
    }
    ...
    /// <returns>Agreement</returns>
    public static Agreement Execute(IPayPalClient apiContext, string token)
    {
        ArgumentValidator.ValidateAndSetupApiContext(apiContext);
    ...
    /// <returns>Agreement</returns>
    public static Agreement Get(IPayPalClient apiContext, string agreementId)
    {
        ArgumentValidator.ValidateAndSetupApiContext(apiContext);
    ...
    /// <param name="patchRequest">PatchRequest</param>
    public static void Update(IPayPalClient apiContext, string agreementId, PatchRequest patchRequest)
    {
        ArgumentValidator.ValidateAndSetupApiContext(apiContext);
        ArgumentValidator.Validate(agreementId, nameof(agreementId));
    ...
    public void Suspend(IPayPalClient apiContext, AgreementStateDescriptor agreementStateDescriptor)
    {
        if (string.IsNullOrWhiteSpace(Id))
            throw new ArgumentException(nameof(Id));
    ...
    /// <param name="apiContext">IPayPalClient used for the API call.</param>
    /// <param name="agreementStateDescriptor">AgreementStateDescriptor</param>
    public void ReActivate(IPayPalClient apiContext, AgreementStateDescriptor agreementStateDescriptor)
    {
        if (string.IsNullOrWhiteSpace(Id))
            throw new ArgumentException(nameof(Id));
    ...
    /// <param name="apiContext">IPayPalClient used for the API call.</param>
    /// <param name="agreementStateDescriptor">AgreementStateDescriptor</param>
    public void Cancel(IPayPalClient apiContext, AgreementStateDescriptor agreementStateDescriptor)
    {
        if (string.IsNullOrWhiteSpace(Id))
            throw new ArgumentException(nameof(Id));
    ...
    /// <param name="apiContext">IPayPalClient used for the API call.</param>
    /// <param name="agreementStateDescriptor">AgreementStateDescriptor</param>
    public void BillBalance(IPayPalClient apiContext, AgreementStateDescriptor agreementStateDescriptor)
    {
        if (string.IsNullOrWhiteSpace(Id))
            throw new ArgumentException(nameof(Id));
    ...
    public void SetBalance(IPayPalClient apiContext, PayPalCurrency currency)
    {
        if (string.IsNullOrWhiteSpace(Id))
            throw new ArgumentException(nameof(Id));
    ...
    /// <param name="agreementId">ID of the billing agreement to perform the operation against.</param>
    /// <param name="currency">Currency</param>
    public static void SetBalance(IPayPalClient apiContext, string agreementId, PayPalCurrency currency)
    {
        ArgumentValidator.ValidateAndSetupApiContext(apiContext);
        ArgumentValidator.Validate(agreementId, nameof(agreementId));
